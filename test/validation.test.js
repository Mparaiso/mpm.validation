...
describe('validation.Chain', function() {
    ...
    it('empty chain validation', function(done) {
        var _chain = validation.Chain();
        _chain.validate("foo", done);
    });
    it('should validate sync', function() {
...
describe("validation.Evenry", function() {
    it('should validate sync', function() {
        var every = validation.Every();
        assert(every.validateSync(['a', 'a']), every.getError());
    });
    it('shouldnt validate sync', function() {
        var every = validation.Every();
        assert(!every.validateSync(['a', 'b']),'it shouldnt validate sync');
    });
});